...
const api = axios.create({
  baseURL: 'https://restaurante-backend-h8jk.onrender.com/api',
...
export const cambiarEstadoUsuario = (id, activo) => api.patch(`/usuarios/${id}/estado?activo=${activo}`)
...
export const cambiarEstadoProducto = (id, estado) => api.patch(`/productos/${id}/estado?estado=${estado}`)
...
export const cambiarEstadoMesa = (id, estado) => api.patch(`/mesas/${id}/estado?estado=${estado}`)
...
export const actualizarIngrediente = (id, data) => api.put(`/inventario/${id}`, data)
export const ajustarStock = (id, data) => api.post(`/inventario/${id}/ajuste`, data)
...
export const cambiarEstadoReserva = (id, estado) => api.patch(`/reservas/${id}/estado?estado=${estado}`)
export const getTurnos = () => api.get('/turnos')
export const abrirTurno = (data) => api.post('/turnos/abrir', data)
export const cerrarTurno = (id, data) => api.patch(`/turnos/${id}/cerrar`, data)
export const getVentasDia = () => api.get('/reportes/ventas-dia')
export const getVentasPeriodo = (inicio, fin) => api.get(`/reportes/ventas-periodo?inicio=${inicio}&fin=${fin}`)
